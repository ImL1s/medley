...
> `auto_update = false` under `[cli]` in `~/.medley/config.toml` (or wherever
> your state directory resolved — see above). Fork-published release artifacts
> are tracked in [#29](https://github.com/ImL1s/grok-build/issues/29).
