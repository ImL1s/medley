...
impl Auth401AttributionCallback for ShellAttribution {
    fn record_401(&self, consumer: SamplingConsumer, comparison: xai_grok_auth::CredentialComparison) {
...
impl ToolAuth401AttributionCallback for ShellAttribution {
    fn record_401(&self, consumer: ToolConsumer, comparison: xai_grok_auth::CredentialComparison) {
