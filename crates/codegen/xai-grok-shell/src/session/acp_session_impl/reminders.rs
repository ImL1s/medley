...
impl SessionActor {
    /// Framed interrupt envelope if the previous turn was interrupted by a user
    /// signal.
    ...
    pub(super) fn maybe_apply_interrupt_envelope(
        ...
        xai_interjection_core::frame_user_turn(xai_interjection_core::INTERRUPT_NOTE, &user_message)
    }
