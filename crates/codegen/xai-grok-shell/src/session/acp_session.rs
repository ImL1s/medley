...
/// Upper bound on how long an unreleased composer edit hold may park a
/// queued prompt before the promoter considers it abandoned. Stamped on the
/// actor loop in `hold_edit` and refreshed if re-held; expiration sweep
...
#[cfg(test)]
pub(crate) fn backdate_edit_hold(
    holds: &mut HashMap<String, std::time::Instant>,
    id: &str,
...
pub(crate) struct State {
    ...
    pub(crate) edit_holds: std::collections::HashMap<String, std::time::Instant>,
